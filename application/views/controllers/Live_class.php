...
class Live_class extends Admin_Controller
{
    ...
    //     $path = "http://biggerbluebutton.com/bigbluebutton/HarvestDistanceLearning2020/api/getRecordings?meetingID=".$meetingID."&checksum=b2dabca332671d7bfc09127b80102fafe4534359";
    //         $array =json_decode(json_encode(simplexml_load_string(file_get_contents(($path)))));
    //     //     echo "<pre>";
    ...
    //     $this->data['meetingID']  = $meetingID;
    //     $this->data['recordings'] =  $array->recordings->recording;
